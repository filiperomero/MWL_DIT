...
var ditDataName = "Nome";
var ditDataYear = "Ano";

// Stats Data - Population
var ditDataPopTotal      = "População total";
var ditDataPopF          = "População Feminina (%)";  
var ditDataPop0to14      = "População entre os 0 e os 14 anos (%)";   
var ditDataPop15to64     = "População entre os 15 e os 64 anos (%)";  
var ditDataPop65         = "População com 65 anos ou mais (%)";  
var ditDataPopGrowth     = "Crescimento Populacional (% anual)";  
var ditDataPopDeathRate  = "Taxa de mortalidade (por 1000 pessoas)";
var ditDataPopLifeExpect = "Expectativa de vida à nascença (anos)";

// Stats Data - Population
var ditDataUnTotal = "Desemprego Total (%)";
var ditDataUnYoung = "Desemprego jovem (% força de trabalho entres os 15 e os 24 anos)";
var ditDataUnYoungF = "Desemprego, juventude feminina (% força de trabalho feminina entres os 15 e os 24 anos)";
var ditDataUnLongTerm = "Desemprego de Longo Prazo (%)";
var ditDataUnLongTermF = "Desemprego de Longo Prazo Feminino (%)";
var ditDataUnWithPrimEdu = "Desempregados com ensino básico (% do desemprego total)";
var ditDataUnWithPrimEduF = "Desempregados com ensino básico, mulheres (% do desemprego feminino total)";
var ditDataUnWithSecEdu = "Desempregados com ensino secundário (% do desemprego total)";
var ditDataUnWithSecEduF = "Desempregados com ensino secundário, mulheres (% do desemprego feminino total)";
var ditDataUnWithTertEdu = "Desempregados com ensino superior (% do desemprego total)";
var ditDataUnWithTertEduF = "Desempregados com ensino superior, mulheres (% do desemprego feminino total)";
var ditDataUnF = "Desemprego, mulheres (% força de trabalho feminina)";
      ...
      function drawTask1Int1(europe) {
        ...
        function update(year) {
            ...
            d3.select("#ditTask1Int1Title")
                .text("Crescimento Populacional (%) - " + year);
            ...
            function dimpleDoIt(country) {
                     ...
                     svg.append('g')
                      ...
                      if (filtered.length === 0) {
                          alert("Não há dados disponíveis par ao país selecionado");
                      } else {
